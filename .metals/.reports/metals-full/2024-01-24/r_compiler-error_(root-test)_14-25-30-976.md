file://<WORKSPACE>/src/test/scala/matmul/MatMulTest.scala
### scala.reflect.internal.Types$TypeError: illegal cyclic inheritance involving class AnyFlatSpec

occurred in the presentation compiler.

action parameters:
uri: file://<WORKSPACE>/src/test/scala/matmul/MatMulTest.scala
text:
```scala
//
// SMatMul tester
...
class SMatMulSpec extends AnyFlatSpec with ChiselScalatestTester {
  ...
  "SMatMul basic test on Treadle" should "pass" taggedAs RequiresTreadle in {
    test(new SMatMul(2))(testSMatMul)
  }
}
